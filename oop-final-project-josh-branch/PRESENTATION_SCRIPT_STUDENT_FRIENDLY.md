...
**Joshua:**
Our project is called the **SSC Student Welfare System**. It’s a computer program that lets students send their problems, suggestions, or feedback to the school’s Student Satisfaction Committee (SSC). The goal is to make it easier for students to be heard and for the school to respond quickly.
